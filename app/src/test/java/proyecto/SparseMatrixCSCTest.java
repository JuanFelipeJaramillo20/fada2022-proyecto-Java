...
class SparseMatrixCSCTest {
        ...
        void createRepresentation() throws FileNotFoundException, OperationNotSupportedException {
                ...
                int rowsD[] = {6, 8, 9, 13, 14, 0, 1, 2, 4, 6, 8, 12, 13, 14, 0, 2, 3, 4, 6, 12, 13, 14, 11, 13, 5, 13,
                ...
                int rowsE[] = {6, 8, 9, 13, 14, 0, 1, 2, 4, 6, 8, 12, 13, 14, 0, 2, 3, 4, 6, 12, 13, 14, 11, 13, 5, 13,
        ...
        void setValue() throws OperationNotSupportedException, FileNotFoundException {
                ...
                instance.createRepresentation(file3);
                instance.setValue(0, 4, 10);
                int rowsC[] = {6, 8, 9, 0, 1, 2, 4, 6, 8, 0, 2, 3, 4, 6, 0, 5, 2, 5, 7, 8, 4, 1, 1, 7, 3, 4, 5, 6, 9,
                                8};
                int colsC[] = {0, 3, 9, 14, 14, 16, 18, 20, 21, 22, 24, 29, 30};
                int valuesC[] = {1, 1, 9, 1, 1, 1, 1, 2, 1, 4, 2, 3, 4, 3, 10, 7, 8, 3, 9, 7, 9, 1, 1, 9, 3, 9, 7, 6,
                                4, 1};
                ...
                instance.createRepresentation(file4);
                instance.setValue(0, 4, 10);
                int rowsD[] = {6, 8, 9, 13, 14, 0, 1, 2, 4, 6, 8, 12, 13, 14, 0, 2, 3, 4, 6, 12, 13, 14, 11, 13, 0, 5,
                                13, 2, 5, 11, 13, 7, 8, 11, 13, 4, 14, 1, 14, 1, 7, 14, 3, 4, 5, 6, 9, 8};
                int colsD[] = {0, 5, 14, 22, 24, 27, 31, 35, 37, 39, 42, 47, 48};
                int valuesD[] = {1, 1, 9, 1, 2, 1, 1, 1, 1, 2, 1, 1, 1, 2, 4, 2, 3, 4, 3, 1, 1, 2, 4, 1, 10, 7, 1, 8,
                                3, 3, 1, 9, 7, 6, 1, 9, 2, 1, 2, 1, 9, 2, 3, 9, 7, 6, 4, 1};
                assertTrue(Arrays.equals(rowsD, instance.getRows()));
                assertTrue(Arrays.equals(colsD, instance.getColumns()));
                assertTrue(Arrays.equals(valuesD, instance.getValues()));
                ...
                instance.createRepresentation(file5);
                instance.setValue(0, 4, 10);
                int rowsE[] = {6, 8, 9, 13, 14, 0, 1, 2, 4, 6, 8, 12, 13, 14, 0, 2, 3, 4, 6, 12, 13, 14, 11, 13, 0, 5,
                                13, 2, 5, 11, 13, 7, 8, 11, 13, 4, 14, 1, 14, 1, 7, 14, 3, 4, 5, 6, 9, 8, 3, 6, 7, 9,
                                11, 12, 13, 1, 2, 3, 6, 8};
                int colsE[] = {0, 5, 14, 22, 24, 27, 31, 35, 37, 39, 42, 47, 48, 48, 55, 60};
                int valuesE[] = {1, 1, 9, 1, 2, 1, 1, 1, 1, 2, 1, 1, 1, 2, 4, 2, 3, 4, 3, 1, 1, 2, 4, 1, 10, 7, 1, 8,
                                3, 3, 1, 9, 7, 6, 1, 9, 2, 1, 2, 1, 9, 2, 3, 9, 7, 6, 4, 1, 2, 7, 7, 2, 9, 2, 3, 1, 2,
                                4, 3, 1};
                assertTrue(Arrays.equals(rowsE, instance.getRows()));
                assertTrue(Arrays.equals(colsE, instance.getColumns()));
                assertTrue(Arrays.equals(valuesE, instance.getValues()));
        ...
        void getSquareMatrix() throws OperationNotSupportedException, FileNotFoundException {
                ...
                int rowsC[] = {6, 8, 9, 0, 1, 2, 4, 6, 8, 0, 2, 3, 4, 6, 5, 2, 5, 7, 8, 4, 1, 1, 7, 3, 4, 5, 6, 9, 8};
                int colsC[] = {0, 3, 9, 14, 14, 15, 17, 19, 20, 21, 23, 28, 29};
                int valuesC[] = {1, 1, 81, 1, 1, 1, 1, 4, 1, 16, 4, 9, 16, 9, 49, 64, 9, 81, 49, 81, 1, 1, 81, 9, 81,
                                49, 36, 16, 1};
                ...
                int rowsD[] = {6, 8, 9, 13, 14, 0, 1, 2, 4, 6, 8, 12, 13, 14, 0, 2, 3, 4, 6, 12, 13, 14, 11, 13, 5, 13,
                                2, 5, 11, 13, 7, 8, 11, 13, 4, 14, 1, 14, 1, 7, 14, 3, 4, 5, 6, 9, 8};
                int colsD[] = {0, 5, 14, 22, 24, 26, 30, 34, 36, 38, 41, 46, 47};
                int valuesD[] = {1, 1, 81, 1, 4, 1, 1, 1, 1, 4, 1, 1, 1, 4, 16, 4, 9, 16, 9, 1, 1, 4, 16, 1, 49, 1, 64,
                                9, 9, 1, 81, 49, 36, 1, 81, 4, 1, 4, 1, 81, 4, 9, 81, 49, 36, 16, 1};
                ...
                int rowsE[] = {6, 8, 9, 13, 14, 0, 1, 2, 4, 6, 8, 12, 13, 14, 0, 2, 3, 4, 6, 12, 13, 14, 11, 13, 5, 13,
                                ...
                                12, 13, 1, 2, 3, 6, 8};
                int colsE[] = {0, 5, 14, 22, 24, 26, 30, 34, 36, 38, 41, 46, 47, 47, 54, 59};
                int valuesE[] = {1, 1, 81, 1, 4, 1, 1, 1, 1, 4, 1, 1, 1, 4, 16, 4, 9, 16, 9, 1, 1, 4, 16, 1, 49, 1, 64,
                                9, 9, 1, 81, 49, 36, 1, 81, 4, 1, 4, 1, 81, 4, 9, 81, 49, 36, 16, 1, 4, 49, 49, 4, 81,
                                4, 9, 1, 4, 16, 9, 1};
        ...
        void getTransposedMatrix() throws OperationNotSupportedException, FileNotFoundException {
                ...
                instance.createRepresentation(file3);
                inst = instance.getTransposedMatrix();
                int rowsC[] = {1, 2, 1, 8, 9, 1, 2, 5, 2, 10, 1, 2, 7, 10, 4, 5, 10, 0, 1, 2, 10, 6, 9, 0, 1, 6, 11, 0,
                                10};
                ...
                instance.createRepresentation(file4);
                inst = instance.getTransposedMatrix();
                int rowsD[] = {1, 2, 1, 8, 9, 1, 2, 5, 2, 10, 1, 2, 7, 10, 4, 5, 10, 0, 1, 2, 10, 6, 9, 0, 1, 6, 11, 0,
                                10, 3,
                                5, 6, 1, 2,
                ...
                instance.createRepresentation(file5);
                inst = instance.getTransposedMatrix();
                int rowsE[] = {1, 2, 1, 8, 9, 14, 1, 2, 5, 14, 2, 10, 13, 14, 1, 2, 7, 10, 4, 5, 10, 0, 1, 2, 10, 13,
                                14, 6, 9, 13, 0, 1,
                                6, 11, 14, 0, 10, 13, 3, 5, 6, 13, 1, 2, 13, 0, 1, 2, 3, 4, 5, 6, 13, 0, 1, 2, 7, 8,
                                9};
